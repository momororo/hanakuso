...
//画面生成
Scene *BadEndScene::createScene(){
    
    auto scene = Scene::create();//WithPhysics();   ←物理設定の場合
    auto layer = BadEndScene::create();
    layer -> setName("layer");
...
bool BadEndScene::init(){
    ...
    //各イベントの割り当て
    listener -> onTouchBegan = CC_CALLBACK_2(BadEndScene::onTouchBegan,this);
    listener -> onTouchMoved = CC_CALLBACK_2(BadEndScene::onTouchMoved,this);
    listener -> onTouchEnded = CC_CALLBACK_2(BadEndScene::onTouchEnded,this);
...
bool BadEndScene::onTouchBegan(Touch *touch, Event *unused_event){
...
void BadEndScene::onTouchMoved(Touch *touch, Event *unused_event){
...
void BadEndScene::onTouchEnded(Touch *touch, Event *unused_event){
...
/*
 ...
 #pragma mark-
 #pragma mark 衝突判定
 bool BadEndScene::onContactBegin(cocos2d::PhysicsContact& contact){
...
void BadEndScene::update( float frame )
{
